import { View, TouchableOpacity, StyleSheet, ScrollView, scrollViewRef } from 'react-native';
...
export default function Sec({ navigation }) {  
  ...
  <Icon color='gray' as={ChevronDown} />
  <Box height= '100%' justifyContent='Center' alignContent='center' alignItems='center' >
    ...
    <Box paddingTop={30} justifyContent='space-evenly' gap={20}>
     <Text style={{fontSize: 20, fontWeight: 'bold', color: 'black'}}>This is a Scroll View</Text>
     <Text style={{fontSize: 20, color: 'black'}}>Component that wraps platform ScrollView while providing integration with touch locking "responder" system.</Text>
    </Box>
    ...
    return (
      <View style={{ flex: 1 }}>
        <DrawerContentScrollView {...props}>
          ...
          >
            <View>
              <Text style={{fontSize: 20,fontWeight: 'bold', color: 'black'}}>Berna Acuna Banaga</Text>
              <Text style={{fontSize: 15, color: 'black'}}>BSIT-3A</Text>
            </View>
